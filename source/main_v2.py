...
Clean CLI interface using orchestrator pattern
"""
...
Examples:
  ...
  python main_v2.py --config my_config.json --output reports/my_report.docx
  
  # Quiet mode (minimal output)
  python main_v2.py --quiet
  
  # Use new Pydantic config format
  python main_v2.py --config examples/config_full.json
        """
    )
